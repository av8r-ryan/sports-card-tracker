    ...
    sports: [
      {
        ...
        majorSets: ["Topps", "Topps Chrome", "Topps Update", "Topps Heritage", "Stadium Club", "Finest", "Archives", "Allen & Ginter"]
      },
      {
        sport: "Football",
        startYear: 1956,
    ...
    sports: [
      {
        ...
        majorSets: ["Prizm", "Select", "Mosaic", "Optic", "Chronicles", "National Treasures", "Immaculate", "Flawless", "Donruss"]
      },
      {
        sport: "Football",
        startYear: 2016,
        exclusive: true, // NFL exclusive
        majorSets: ["Prizm", "Select", "Mosaic", "Optic", "Chronicles", "National Treasures", "Immaculate", "Contenders", "Donruss"]
      },
      {
        sport: "Soccer",
        startYear: 1970,
    ...
    sports: [
      {
        ...
        majorSets: ["Upper Deck", "SP Authentic", "The Cup", "Ultimate Collection", "Ice", "Series 1", "Series 2", "Young Guns"]
      },
      {
        sport: "Basketball",
        startYear: 1991,
...
export class ManufacturerDatabaseService {
  ...
  getValidManufacturers(sport: string, year: number): string[] {
    ...
    Object.entries(MANUFACTURER_DATABASE).forEach(([name, info]) => {
      const sportLicense = info.sports.find(s => 
        s.sport === sport && 
        year >= s.startYear && 
        (!s.endYear || year <= s.endYear)
      );
   ...
   */
  getRealisticManufacturer(sport: string, year: number, isRookie: boolean = false): {
    manufacturer: string;
    set: string;
  } {
