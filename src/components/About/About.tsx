    ...
    () => [
      {
        ...
        social: {
          linkedin: 'https://linkedin.com/in/sookiewentzel',
          twitter: 'https://twitter.com/sookiewentzel',
        },
      },
      {
        id: '2',
        ...
        bio: 'The technical mastermind and supportive father behind CardFlex™. Ryan brings decades of experience in technology and business, ensuring the platform is robust, secure, and user-friendly.',
        avatar: '🥷',
        skills: ['Technology', 'Business Strategy', 'Mentorship', 'Problem Solving'],
        social: {
          linkedin: 'https://linkedin.com/in/ryanwentzel',
          twitter: 'https://twitter.com/ryanwentzel',
        },
      },
      {
        id: '3',
...
Dragon isn't scary unless you fear enthusiastic kisses. She's the magical heartbeat of our card-collecting community, reminding everyone that this hobby works best with imagination, friendship, and a wonderfully wiggly Good Girl by your side.`,
        ...
        social: {
          twitter: 'https://twitter.com/dragonmascot',
        },
      },
    ],
    []
